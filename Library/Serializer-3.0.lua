...
local function SerializeValue(v, res, nres)
	...
	elseif t=="nil" then		-- ^Z = nil (zero, "N" was taken :P)
		...
		error(": Cannot serialize a value of type '"..t.."'")	-- can't produce error on right level, this is wildly recursive
	end
...
local serializeTbl = { "^1" }	-- "^1" = Hi, I'm data serialized by lib protocol rev 1
...
lib.internals = {	-- for test scripts
